...
export const kodeHighlight = HighlightStyle.define([
  ...
  { tag: [t.heading], color: "#818cf8", fontWeight: "600" },
...
export const kodeTheme = EditorView.theme(
  {
    ...
    ".cm-content": { caretColor: "#818cf8", padding: "10px 0" },
    ".cm-line": { padding: "0 16px 0 10px" },
    ".cm-matchingBracket": { backgroundColor: "rgba(99,102,241,0.22) !important", outline: "1px solid rgba(129,140,248,0.45)", borderRadius: "4px" },
    ".cm-foldPlaceholder": { background: "rgba(255,255,255,0.06)", border: "none", color: "#94a3b8", padding: "0 6px", borderRadius: "6px" },
